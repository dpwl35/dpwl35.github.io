...
DrawCall : CPU가 GPU에 요청
DrawCall 상한치 PC : 1000 / Mobile : 100 ~200
...
Draco는 Google에서 개발한 오픈 소스 3D 그래픽 압축 라이브러리.
CesiumGS / gltf-pipeline : glTF 자산을 최적화하기 위한 콘텐츠 파이프라인 도구
